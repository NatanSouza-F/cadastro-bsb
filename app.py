...
st.subheader("Onboarding Inteligente de Clientes")
...
if not st.session_state.cadastro_realizado:
    ...
    if perfil == "Empresa (PJ)":
        ...
        st.selectbox("Certificado digital?", ["Sim", "Não"], key="in_certificado")
        ...
        st.checkbox("Aceito termos LGPD", key="in_lgpd")

        st.button("Finalizar", on_click=processar_envio_pj)
        ...
        st.button("Finalizar", on_click=processar_envio_pf, args=(st.session_state.doc_ok,))
